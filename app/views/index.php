...
<main>
    <section class="vh-100 d-flex align-items-end"
        ...
        <div class="m-5" style="color: #FEFFD2;">
            <h1>
                A Masterpiece In Stitches
            </h1>
            <h5>
                Experience the beauty of perfect stitches,<br>
                Computer embroidery brings designs to life with stunning precision.
            </h5>
        </div>
    </section>
</main>