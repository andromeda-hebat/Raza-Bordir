            ...
            <div class="px-5 pt-3 pb-5">
                <section>
                    ...
                    <div class="d-flex mt-2">
                        <div class="card card-body me-4 d-flex justify-content-center border-black"
                            style="width: 25vh;">
                            <div class="text-center">
                                <svg class="mb-2" width="90" height="90" viewBox="0 0 90 90" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="45" cy="45" r="44.5" fill="#A7977F" fill-opacity="0.51"
                                        stroke="black" />
                                </svg>
...
<script>
    ...
    // Data Penjualan
    const salesData = {
        labels: ['1', '3', '6', '8', '11', '15', '18', '20', '22', '24', '28', '30'], // Tanggal
        datasets: [{
            label: 'Penjualan',
            data: [20, 18, 15, 25, 20, 15, 21, 17, 29, 22, 12, 18], // Data penjualan
